...
export class TasksService {
  ...
  async applyTemplate(
    ...
    const templates = {
      RAMADAN: [
        {
          title: 'Persiapan Sahur',
          category: 'Ibadah',
          description: 'Menyiapkan menu sahur bergizi',
        },
        {
          title: 'Khatam Quran Target 1 Juz',
          category: 'Ibadah',
          description: 'Tadarus bersama setelah Subuh',
        },
        {
          title: 'Sedekah Iftar',
          category: 'Sosial',
          description: 'Menyiapkan 10 paket takjil untuk masjid',
        },
      ],
      HOUSEHOLD_DAILY: [
        {
          title: 'Pembersihan Ruang Tamu',
          category: 'Rumah',
          description: 'Menyapu dan merapikan mainan',
        },
        {
          title: 'Siram Tanaman',
          category: 'Rumah',
          description: 'Pagi dan Sore',
        },
      ],
      FINANCE_WEEKLY: [
        {
          title: 'Evaluasi Pengeluaran Pekanan',
          category: 'Finance',
          description: 'Input sisa nota ke Yumna',
        },
        {
          title: 'Alokasi Dana Darurat',
          category: 'Finance',
          description: 'Pindahkan 10% sisa budget',
        },
      ],
    };
    ...
    return Promise.all(
      tasksToCreate.map((t) =>
        this.create(creatorId, familyId, {
          ...t,
          priority: 'MEDIUM',
        }),
      ),
